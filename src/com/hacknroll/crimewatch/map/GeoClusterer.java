...
public class GeoClusterer {
	...
	public List<GeoCluster> clusters_ = new ArrayList<GeoCluster>();
	 ...
	 */
	public GeoClusterer(MapView mapView, List<MarkerBitmap> markerIconBmps, float screenDensity, boolean alertDialogCheck [], Context mapContext){
		mapView_ = mapView;
	 ...
	 */
	 public void createCluster(GeoItem item){
		 GeoCluster cluster = new GeoCluster(this, mapContext);
		 cluster.addItem(item);
	...
	public class GeoCluster {
		...
		public List<GeoItem> items_ = new ArrayList<GeoItem>();
		/** ClusterMarker object */
		protected ClusterMarker clusterMarker_;
		/** zoomlevel at the point Cluster was made */
		private int zoom_;
		/** alert dialog to check if a dialog is already displaying **/
		public boolean alertDialogCheck [];
		/** Map context **/
		Context mapContext;
		 ...
		 */
		public GeoCluster(GeoClusterer clusterer, Context mapContext){
			clusterer_ = clusterer;
			clusterMarker_ = null;
			this.alertDialogCheck = clusterer.alertDialogCheck;
		...
		public void onTapCalledFromMarker(boolean flg) {
			//Log.d ("TAG", "onTapCalledFromMarker");
		...
		public void redraw(){
			...
			if(clusterMarker_ == null) {
				clusterMarker_ = new ClusterMarker(this,markerIconBmps_,screenDensity_, alertDialogCheck, mapContext, mapView_);
				//clusterMarker_.onTap(clusterMarker_.getLocation(), mapView_);
				List<Overlay> mapOverlays = mapView_.getOverlays();
