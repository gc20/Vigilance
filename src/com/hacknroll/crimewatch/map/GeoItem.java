...
import com.hacknroll.crimewatch.Crimes;
...
public class GeoItem implements Parcelable {
	 ...
	 */
	public GeoItem(long id, int latitudeE6, int longitudeE6, Crimes incidentDetails) {
		id_ = id;
